    ...
    <div class="body" ref="body">
      <div class="wrap">
        <div class="local flag">
          ...
          <div class="list">
            <div class="item">
              <span class="icon-local iconfont">&#xe604;</span
              >{{ localCity.name }}
            </div>
          </div>
        </div>
        <div class="history flag">
          ...
          <div class="list">
            <div class="item" v-for="item in historyCity" :key="item.id">
              {{ item.name }}
            </div>
          </div>
        </div>
        <div class="hot flag">
          ...
          <div class="list">
            <div class="item" v-for="item in hotCity" :key="item.id">
              {{ item.name }}
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    getCity() {
      ...
      that.localCity = res.data.locationCity;
      that.historyCity = res.data.historyCity;
    ...
    selectMenu(index) {
      let flagList = document.getElementsByClassName("flag");
